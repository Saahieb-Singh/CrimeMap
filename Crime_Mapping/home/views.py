...
def map(request):
    ...
    for report in allreport: 
        d='lightgray'
        if(report.Dhaara=='Internet Fraud'):
             d = 'red'
        if(report.Dhaara=='Dacoity'):
             d = 'blue'
        if(report.Dhaara=='Racketeering'):
             d = 'green'
        if(report.Dhaara=='Organised Crime'):
             d = 'purple'
        if(report.Dhaara=='Human Trafficking'):
             d = 'orange'
        if(report.Dhaara=='Money Laundering'):
             d = 'darkred'
        if(report.Dhaara=='Robbery'):
             d = 'lightred'
        if(report.Dhaara=='Terrorism'):
             d = 'lightgray'
        if(report.Dhaara=='Arms Trafficking'):
             d = 'darkblue'
        if(report.Dhaara=='Gambling'):
             d = 'darkgreen'
        if(report.Dhaara=='Forgery'):
             d = 'gray'
        if(report.Dhaara=='Illegal Drug Trade'):
             d = 'white'
        if(report.Dhaara=='Murder'):
             d = 'black'
        if(report.Dhaara=='Poaching and wildlife Trafficking'):
             d = 'pink'
        if(report.Dhaara=='Cybercrime'):
             d = 'lightblue'
        folium.Marker(
